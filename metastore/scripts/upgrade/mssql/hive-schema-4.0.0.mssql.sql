...
INSERT INTO CTLGS VALUES (1, 'hive', 'Default catalog for Hive', 'TBD', DATEDIFF(SECOND, DATETIMEFROMPARTS(1970, 1, 1, 0, 0, 0, 0), GETDATE()));
...
ALTER TABLE DBS ADD CONSTRAINT DBS_FK1 FOREIGN KEY (CTLG_NAME) REFERENCES CTLGS ([NAME]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
CREATE TABLE SCHEDULED_QUERIES (
  ...
  [ENABLED] BIT,
  CLUSTER_NAMESPACE nvarchar(128),
  SCHEDULE nvarchar(128),
  [USER] nvarchar(128),
  QUERY nvarchar(MAX),
  NEXT_EXECUTION bigint
)

ALTER TABLE SCHEDULED_QUERIES ADD CONSTRAINT SCHEDULED_QUERIES_PK PRIMARY KEY (SCHEDULED_QUERY_ID);

CREATE TABLE SCHEDULED_EXECUTIONS (
  SCHEDULED_EXECUTION_ID bigint NOT NULL,
  SCHEDULED_QUERY_ID bigint,
  EXECUTOR_QUERY_ID nvarchar(128),
  STATE nvarchar(128),
  START_TIME int,
  END_TIME int,
...
ALTER TABLE SCHEDULED_EXECUTIONS ADD CONSTRAINT SCHEDULED_EXECUTIONS_PK PRIMARY KEY (SCHEDULED_EXECUTION_ID);



CREATE TABLE RUNTIME_STATS (
  RS_ID bigint not null primary key,
